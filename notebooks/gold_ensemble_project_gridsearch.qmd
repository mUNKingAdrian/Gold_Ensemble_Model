...
---
title: "Gold Price Modeling Project: Ensemble Methods"
author: "Adrian King"
format:
  html:
    toc: true
...
3. Engineer lagged and rolling features from price and volume.
...
```{python}
file_path ='data/finalgolddata.csv'
...
- whether the ensemble improved on the tuned base learners
...
4. Test class imbalance strategies if one direction becomes dominant.
5. Reframe the task as regression to predict the next closing price or return.
6. Compare against a naïve benchmark such as always predicting the majority class or always predicting the previous direction.
